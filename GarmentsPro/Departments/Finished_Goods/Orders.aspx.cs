        ...
        protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Start":
                    ...
                    string MyQa = "BEGIN TRANSACTION; UPDATE OrderStatus SET OrderStatus.Finished_Goods =@YP   FROM OrderStatus T1,  Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID; " +
                                   "UPDATE Status SET Status.Finished_Goods =@YP   FROM OrderStatus T1, Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID; COMMIT;";
                ...
                case "Hold":
                    ...
                    string MysQ = "BEGIN TRANSACTION; UPDATE OrderStatus SET OrderStatus.Finished_Goods =@YP   FROM OrderStatus T1,  Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID; " +
                                   "UPDATE Status SET Status.Finished_Goods =@YP   FROM OrderStatus T1, Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID; COMMIT;";
                ...
                case "Finish":
                    ...
                    string MYQF = "BEGIN TRANSACTION; UPDATE OrderStatus SET OrderStatus.Finished_Goods =@YP   FROM OrderStatus T1,  Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID;" +
                                        "UPDATE Status SET Status.Finished_Goods =@YP   FROM OrderStatus T1, Status T2 WHERE T1.OID = T2.OID and T1.OID = @OID; COMMIT; ";
