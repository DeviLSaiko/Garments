<%@ Page Title="" Language="C#" MasterPageFile="~/Departments/Yarn_Formation/YarnFormation.Master" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="GarmentsPro.Departments.Yarn_Formation.Orders" %>
    ...
    <asp:UpdatePanel ID="updatepnl" runat="server">
        <ContentTemplate>
            ...
            <div class="col-md-12 align-content-center">
                <asp:GridView ID="GridView1" CssClass=" table"  HeaderStyle-CssClass="align-content-center" OnRowDataBound="GridView1_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Completed" ControlStyle-Font-Size="Small" >
                            <ItemTemplate>
